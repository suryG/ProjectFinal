...
function CarouselComponent_a_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassProp("disabled", ctx_r2.checkDisabledClass("prev"));
...
function CarouselComponent_a_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassProp("disabled", ctx_r3.checkDisabledClass("next"));
...
SlideComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: SlideComponent, selectors: [["slide"]], hostVars: 15, hostBindings: function SlideComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵattribute("aria-hidden", !ctx.active);
        ɵngcc0.ɵɵstyleProp("width", ctx.itemWidth)("order", ctx.order);
        ɵngcc0.ɵɵclassProp("multilist-margin", ctx.multilist)("active", ctx.active)("carousel-animation", ctx.isAnimated)("item", ctx.addClass)("carousel-item", ctx.addClass);
